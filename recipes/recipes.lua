...
for name, recipe in pairs(game.player.force.recipes) do game.player.print(name) end
...
inspect_all(game.recipe_prototypes)

game.write_file("recipe_prototypes", out)